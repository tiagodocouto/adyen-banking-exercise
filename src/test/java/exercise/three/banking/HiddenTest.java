...
public class HiddenTest {
    ...
    public void setUp() throws Exception {
        ...
        john = bank.openAccount(person1john, "1111", 0.0);
        julia = bank.openAccount(person2julia, "2222", 456.78);
        daniel = bank.openAccount(person3daniel, "3333", 500.00);
        bob = bank.openAccount(company1bob, "1111", 0.0);
        smith = bank.openAccount(company2smith, "2222", 123456789.00);
    }
